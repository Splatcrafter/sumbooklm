...
export function AuthCard({
  ...
  return (
    <div className="flex flex-col gap-3">
      <section className="rounded-jb-block border border-jb-black/80 bg-jb-black/72 p-7 shadow-[0_28px_70px_-20px_rgb(0_0_0/0.85)] ring-1 ring-jb-grey-70/20 ring-inset backdrop-blur-2xl">
      ...
      <aside className="rounded-jb-card border border-jb-black/80 bg-jb-black/55 px-5 py-3.5 text-sm text-jb-grey-50 shadow-[0_16px_40px_-24px_rgb(0_0_0/0.8)] ring-1 ring-jb-grey-70/15 ring-inset backdrop-blur-xl">
        {footer}
      </aside>
    </div>
  );
